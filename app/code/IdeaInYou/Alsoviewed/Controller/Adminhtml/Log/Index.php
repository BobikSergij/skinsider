...
namespace IdeaInYou\Alsoviewed\Controller\Adminhtml\Log;
...
class Index extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'IdeaInYou_Alsoviewed::log';
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('IdeaInYou_Alsoviewed::alsoviewed_log')
