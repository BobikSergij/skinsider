...
namespace IdeaInYou\Alsoviewed\Controller\Adminhtml\Relation;
...
class Edit extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'IdeaInYou_Alsoviewed::relation';

    /**
     * @var \IdeaInYou\Alsoviewed\Model\RelationFactory
     */
     ...
     * @param \IdeaInYou\Alsoviewed\Model\RelationFactory $relationFactory
     * @param \Magento\Framework\View\Result\PageFactory $resultPageFactory
     * @param \Magento\Framework\Registry $registry
     */
    public function __construct(
        \Magento\Backend\App\Action\Context $context,
        \IdeaInYou\Alsoviewed\Model\RelationFactory $relationFactory,
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('IdeaInYou_Alsoviewed::alsoviewed_relation')
