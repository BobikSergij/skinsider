...
namespace IdeaInYou\Alsoviewed\Model;
...
class BasisCollector
{
    ...
    protected $basisClasses = [
        self::BASIS_CURRENT_PRODUCT     => '\IdeaInYou\Alsoviewed\Model\Basis\CurrentProduct',
        self::BASIS_RECENTLY_VIEWED     => '\IdeaInYou\Alsoviewed\Model\Basis\RecentlyViewed',
        self::BASIS_RECENTLY_COMPARED   => '\IdeaInYou\Alsoviewed\Model\Basis\RecentlyCompared',
        self::BASIS_SHOPPING_CART       => '\IdeaInYou\Alsoviewed\Model\Basis\ShoppingCart',
    ];
