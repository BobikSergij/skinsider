...
use IdeaInYou\Alsoviewed\Api\Data\RelationInterface;
...
class Relation extends AbstractModel implements RelationInterface
{
    ...
    {
        $this->_init('IdeaInYou\Alsoviewed\Model\ResourceModel\Relation');
     ...
     *
     * @return \IdeaInYou\Alsoviewed\Model\Relation
     */
